    ...
    <div className="min-h-screen bg-secondary-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <Link to="/" className="flex justify-center items-center space-x-2 mb-6">
          ...
          <span className="text-3xl font-heading font-bold text-secondary-900">
            carwow
          </span>
        </Link>
        
        <h2 className="text-center text-3xl font-heading font-bold text-secondary-900">
          Create your account
        </h2>
        ...
        <div className="bg-white py-8 px-4 shadow-soft sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="accept-terms" className="ml-2 block text-sm text-secondary-900">
                I agree to the{' '}
            ...
            {errors.acceptTerms && (
              <p className="mt-1 text-sm text-accent-600">{errors.acceptTerms.message}</p>
            )}
